...
| [api-reference.md](api-reference.md) | All routes by feature area |
| [glossary.md](glossary.md) | Domain terms |
| [cross-client-invariants.md](cross-client-invariants.md) | Values that must stay in sync across clients |
| [architecture.md](architecture.md) | Component diagram + request lifecycles |
| [config-reference.md](config-reference.md) | Env vars, feature flags, runtime tunables |
