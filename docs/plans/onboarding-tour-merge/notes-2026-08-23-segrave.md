# Segrave — Onboarding Flow Notes (verbatim, received 2026-08-23)

> Captured word-for-word from the operator's message. The dispositions live in
> [plan.md](plan.md); this file is the source record and is not edited.
...
* Notes on the manual calculator experience.
