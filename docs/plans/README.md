...
|---|---|---|---|
| [win-now/](win-now/) | 4 | **implemented, locally verified** · 2026-09-04 | External weekly forecasts, league season simulation and constrained Win Now search/evaluation in mobile/web. Parent review complete; all three flags false. Hosted CI, physical TestFlight and calibration remain rollout gates. [BUILD](win-now/BUILD.md), [EVIDENCE](win-now/EVIDENCE.md). |
