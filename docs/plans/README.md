...
|---|---|---|---|
| [fit-challenger/](fit-challenger/) | 4 | **built, not rostered** · 2026-08-19 | Bake-off arm `fit`: thin knockouts + dual 0–100 team scores, present by sum. Preferences filter after scoring. Organic serving unchanged. Code on `feat/fit-challenger`; `bakeoff_include_fit=0`. EM [PRD.md](fit-challenger/PRD.md). |
