...
|---|---|---|---|
| [ppg-impact/](ppg-impact/) | 3 | **active, not built** · 2026-08-19 | Starter PPG before/after on each suggested trade. Free sources: Sleeper unofficial projections + nflverse trailing. Does **not** change generation. EM-facing [PRD.md](ppg-impact/PRD.md). |
