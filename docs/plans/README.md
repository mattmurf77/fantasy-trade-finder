...
|---|---|---|---|
| [landability-challenger/](landability-challenger/) | 3 | **active, not built** · 2026-08-19 | Bake-off arm D: both-willing / less-lopsided overlay on the live engine, generated dark against `current`. Historical arm A is **not** this work. EM-facing [PRD.md](landability-challenger/PRD.md); tickets in the [README](landability-challenger/README.md). |
