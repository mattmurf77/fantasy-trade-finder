...
|---|---|---|---|
| [card-evidence/](card-evidence/) | 3 | **active, not built** · 2026-08-19 | Presentment around suggested trades (honest verdict, both-team impact, you-vs-market, offer analyzer, league comps). Does **not** change generation. EM-facing [PRD.md](card-evidence/PRD.md). Sister of landability-challenger (which cards exist). |
