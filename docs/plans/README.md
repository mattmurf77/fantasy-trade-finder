...
| [web-parity/](web-parity/) | 3 | **Phase 0 built, unmerged** · 2026-08-19 | Bringing `fantasy-trade-finder.onrender.com` up to par with the mobile app. Evidence base is [`../reviews/2026-08-19-web-parity-audit.md`](../reviews/2026-08-19-web-parity-audit.md). Phase 0 (live-user breakage) is built on `fix/web-phase0` with `scope.md` — **not merged, not deployed**. Phases 1–3 unstarted: shared-token extraction, a first-ever web test harness, then a backend-free parity backlog. **Operator decisions still open** — posture (front door / companion / full parity) gates Phase 3, plus the `[STATE]` governing-law value and 3 waivers in `scope.md` §6. |
