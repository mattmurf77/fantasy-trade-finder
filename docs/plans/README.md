...
|---|---|---|---|
| [fit-challenger/](fit-challenger/) | 4 | **active, not built** · 2026-08-19 | Bake-off arm `fit`: thin knockouts + dual 0–100 team scores, present by sum. Preferences filter after scoring. Organic serving unchanged. EM [PRD.md](fit-challenger/PRD.md). |
