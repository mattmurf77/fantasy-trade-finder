...
| `living-memory/DECISIONS.md` | **updated — D-031 and D-032** | D-031 beat-identity gate with all three reasons a count fails; the candidate entry was allocated as **D-032** (request-first, consume-on-success). |
| `living-memory/GOTCHAS.md` | **updated — G-029** | Shared with P0-7; carries the 33-of-73 sweep and names `guide_tour_reenabled` as still broken. |
