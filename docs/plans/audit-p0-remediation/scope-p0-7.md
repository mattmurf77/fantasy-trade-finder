...
| `living-memory/DECISIONS.md` | **updated — D-030** | Both choices, incl. why all-client and all-server were each impossible. |
| `living-memory/GOTCHAS.md` | **updated — G-029** | Strengthened per the sweep: 33 of 73, three fixed, 29 left, and the `quickset_completed` special case. |
