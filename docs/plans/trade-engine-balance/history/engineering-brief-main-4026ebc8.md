...
**Status:** Historical research; policy superseded by the [owner-contract implementation scope](../../owner-contracts/scope.md) and D-185. This brief is not an unqualified build specification.\
**Date:** 2026-09-04\
