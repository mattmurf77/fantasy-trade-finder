...
**Status:** Historical research and superseded policy proposal\
**Date:** 2026-09-04\
...
**September 5, 2026 update:** Read [the owner-decisions engineering handoff](../decisions.md) before implementing. Later interview answers supersede this document's unapproved policy, confidence-weighting, presentation and revalidation prescriptions. The database observations below remain dated historical evidence; retain relevant attribution/snapshot ideas only after reconciling the newer tier, privacy, timing and selection contracts. This document has not been retroactively rewritten to make the earlier proposal appear owner-approved.
