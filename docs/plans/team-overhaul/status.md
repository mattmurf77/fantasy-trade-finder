...
```project-status
{
  "status": "live for TestFlight: flag ON (d59a86d7), all-platform sends merged, iOS 153 uploaded; 153 device pass found blank chips + two crashes (card shape) — fixed, shipping as 154; device checklist unrun",
  "updated": "2026-09-08",
