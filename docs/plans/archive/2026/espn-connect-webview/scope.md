...
`docs/plans/archive/2026/espn-league-linking-plan-2026-07-11.md` §4 Option 1
...
- [x] **New flow:** `archive/retired-tooling/mobile/maestro/` ESPN-connect flow — covers: open link sheet
