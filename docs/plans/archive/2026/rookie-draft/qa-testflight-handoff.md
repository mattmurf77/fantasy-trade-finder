...
**Read first, in order:**
1. `docs/plans/archive/2026/rookie-draft/plan.md` — the converged plan; §1's D-criteria table is the acceptance contract; the "Operator decisions" section at the bottom binds everything.
2. `docs/plans/archive/2026/rookie-draft/build-m2-mobile.md` — has the 7-item Maestro QA list for the rookie-scope surfaces.
3. `docs/plans/archive/2026/rookie-draft/build-m4.md` — Draft Room states + the explicitly-deferred tests T-M4-01..06 (T-M4-06 = the live-poll release gate).
4. `docs/plans/archive/2026/rookie-draft/measurement.md`, `hld.md`/`lld.md` as reference.
5. Repo conventions: root `CLAUDE.md` (esp. secrets in `secrets.local.env`, feedback pipeline, Chalkline rules) and `archive/retired-tooling/maestro-skill` if present.
