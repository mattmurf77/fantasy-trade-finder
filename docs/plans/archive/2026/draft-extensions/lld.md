...
5. **Publish.** Write `docs/plans/archive/2026/draft-extensions/mock-calibration-2026-08.md`: the corpora used and their shape check, the split, the grid, the fitted value, both bars' numbers on the hold-out and on the independent corpus, and the verdict. This is interface **I-10** — a **gate artifact**, not a report.
...
| **W2** | 4-touch for `draft.mock` · `docs/data-dictionary.md` — new `## mock_drafts` section · `docs/api-reference.md` — a new `## Mock draft (flag draft.mock)` section after `## Draft room` (`:311`) · `docs/config-reference.md` §model_config — `mock_max_reach_slots`, `mock_jitter_slots` · `docs/glossary.md` — "Mock draft", "Drafter persona", "Need severity", "Reach" · `docs/plans/archive/2026/draft-extensions/mock-calibration-2026-08.md` (I-10, the gate artifact) |
