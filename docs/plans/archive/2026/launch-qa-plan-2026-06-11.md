```project-status
{
  "status": "superseded",
  "updated": "",
  "summary": "Launch QA Plan — Agent Roles & Test Phases",
  "evidence": "Carried forward as the last documented disposition, not a fresh production audit. Prior index merge corrections take precedence over older pre-merge notes. Last documented index disposition: superseded  — The 2026-06 pre-launch QA sweep. Findings acted on; the plan is not a live process.. Prior row preserved at ../../../reviews/2026/2026-09-06-project-status-migration/plans-index.md."
}
```
