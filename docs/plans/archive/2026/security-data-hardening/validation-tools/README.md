...
```sh
python3.12 docs/plans/archive/2026/security-data-hardening/validation-tools/run_python312.py
```
...
python3.12 docs/plans/archive/2026/security-data-hardening/validation-tools/run_postgres.py \
