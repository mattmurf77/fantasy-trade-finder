...
The missing historical targets are `docs/plans/landability-challenger/PRD.md`, `docs/reviews/2026/2026-08-18-trade-logic-archaeology.md`, and `docs/reviews/2026/2026-08-18-valuation-age-audit.md`; DECISIONS also references the missing `docs/plans/landability-challenger/scope.md`.
