...
| `archive/retired-tooling/mobile/maestro/flows/p0-5-account-only-picker.yaml` **(new)** | 7 | §11.1 |
| `archive/retired-tooling/mobile/maestro/capture/leagues@account-only.yaml` **(new)** | 7 | §11.2 |
...
id today** (`grep -rn link-sleeper archive/retired-tooling/mobile/maestro mobile/scripts` → no matches), so
...
### 11.1 `archive/retired-tooling/mobile/maestro/flows/p0-5-account-only-picker.yaml`
...
### 11.2 `archive/retired-tooling/mobile/maestro/capture/leagues@account-only.yaml`
...
- `archive/retired-tooling/mobile/maestro/capture/leagues@fresh.yaml` (HLD §6 row 13) — signs in as the
...
- `archive/retired-tooling/mobile/maestro/flows/smoke/01-signin.yaml` and `02-league-pick.yaml` — the guard on
  change B (`initialRoute`).
- `archive/retired-tooling/mobile/maestro/capture/settings.yaml` — the guard on the `LinkSleeperSheet`
