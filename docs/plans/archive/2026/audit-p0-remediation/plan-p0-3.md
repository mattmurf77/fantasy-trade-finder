...
| Fact | Evidence |
|---|---|
| Deep links are unusable in Maestro — `openLink` raises an undismissable SpringBoard confirm on iOS 18 | `archive/retired-tooling/mobile/maestro/README.md:140-146` (law 17), `mobile/src/utils/testRouteEntry.ts:14-18` |
...
Constraint first: **`openLink` cannot be used** (README law 17, `archive/retired-tooling/mobile/maestro/README.md:140-146`).
...
**New flow — `archive/retired-tooling/mobile/maestro/flows/league/invite-join.yaml`** (`# flags: release`), three
blocks:
