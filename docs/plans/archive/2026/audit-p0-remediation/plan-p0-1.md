...
it. `archive/retired-tooling/mobile/maestro/capture/league@quickset-done.yaml` photographs it as
...
16. New flow `archive/retired-tooling/mobile/maestro/flows/p0-1-quickset-unlock.yaml` (§6).
17. `archive/retired-tooling/mobile/maestro/capture/league@quickset-done.yaml` — rename the capture
...
Conventions: `archive/retired-tooling/mobile/maestro/README.md` — flow-authoring laws 1-23. The laws
that bind this delta are called out inline.

### 6.1 New flow — `archive/retired-tooling/mobile/maestro/flows/p0-1-quickset-unlock.yaml`
...
### 6.2 Amended capture — `archive/retired-tooling/mobile/maestro/capture/league@quickset-done.yaml`
...
`archive/retired-tooling/mobile/scripts/screen-freshness.sh`, re-capturing only what it flags. The
