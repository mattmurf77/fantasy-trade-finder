...
archive/retired-tooling/mobile/maestro/flows/p0-1-quickset-unlock.yaml            (new)
...
> interactions → `unlocked:false`); see `docs/plans/archive/2026/audit-p0-remediation/`. Also the
...
### 8.1 New flow — `archive/retired-tooling/mobile/maestro/flows/p0-1-quickset-unlock.yaml`
...
### 8.2 Amended capture — `archive/retired-tooling/mobile/maestro/capture/league@quickset-done.yaml`
...
2. **Rewrite the header** (`:9-45`): the profile now shows a Quick Set user whose
   ...
   `docs/plans/archive/2026/audit-p0-remediation/`. The paragraph at `:26-29` claiming *"The
