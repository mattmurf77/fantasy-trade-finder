...
Full design + verification: docs/plans/archive/2026/audit-p0-remediation/plan-p0-2.md
-->
...
- [x] **New flow:** `archive/retired-tooling/mobile/maestro/flows/trades-generation-failure.yaml` — covers all
...
- [x] **Extended flow:** `archive/retired-tooling/mobile/maestro/capture/trades.yaml` — **mandatory, not optional.**
...
- **`testID`s added:** `trades.deck-error` (container `View`), `trades.deck-error.retry`
  ...
  error copy, permitted by `docs/plans/archive/2026/mobile-testing/lld.md:253`.
...
- **Capture delta:** `trades` — run `archive/retired-tooling/mobile/scripts/screen-capture.sh --screen trades`
...
- **Simulator-gate tier:** **Tier 1** — mobile screen / state change
  ...
  - the feature's own flow `archive/retired-tooling/mobile/maestro/flows/trades-generation-failure.yaml`,
  - the updated capture flow `archive/retired-tooling/mobile/maestro/capture/trades.yaml`,
  - `archive/retired-tooling/mobile/scripts/screen-capture.sh --screen trades` (visuals changed on the trades screen).
