...
`archive/retired-tooling/mobile/maestro/04-tabs-navigation.yaml` (drives every `tabPress` handler this change
edits) and `archive/retired-tooling/mobile/maestro/flows/smoke/09-league.yaml` (mounts both League screens) must
