...
`TradesScreen.tsx`; do not edit `archive/retired-tooling/mobile/maestro/04-tabs-navigation.yaml` or
`archive/retired-tooling/mobile/maestro/flows/smoke/09-league.yaml` (**any diff to either invalidates P0-7's
