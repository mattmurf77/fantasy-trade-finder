...
Proved by `archive/retired-tooling/mobile/maestro/flows/p0-6-espn-copy-trade.yaml` on the `espn` profile, in one session,
...
- Sleeper-profile captures are pixel-identical; `archive/retired-tooling/mobile/scripts/screen-freshness.sh` flags
