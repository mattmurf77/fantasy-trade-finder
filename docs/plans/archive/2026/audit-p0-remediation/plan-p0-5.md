...
| 10 | `archive/retired-tooling/mobile/maestro/flows/p0-5-account-only-picker.yaml` **(new)** | See §5. | new flow |
...
2. **Client** (`mobile/src/screens/SignInScreen.tsx`): gate **only** the SDK call. When
   ...
   `mobile/src/utils/testRouteEntry.ts:51-56`, produced solely by `archive/retired-tooling/mobile/scripts/sim-build.sh` and
...
### New flow — `archive/retired-tooling/mobile/maestro/flows/p0-5-account-only-picker.yaml`
...
**Extended flow:** `archive/retired-tooling/mobile/maestro/capture/leagues@fresh.yaml` — **unchanged**, and that is a
...
**Capture delta:** new `archive/retired-tooling/mobile/maestro/capture/leagues@account-only.yaml` for the screen library
