...
```python
    # P0-7 remediation (docs/plans/archive/2026/audit-p0-remediation/plan-p0-7.md; addendum
...
`archive/retired-tooling/mobile/maestro/` (or a written waiver in the scope block)."* This change is
...
`smoke/07-calculator` — plus `archive/retired-tooling/mobile/scripts/screen-freshness.sh`, re-capturing only what
