...
(`archive/retired-tooling/mobile/maestro/flows/smoke/11-apple-entitlement.yaml` terminates at the native boundary), and
...
`backend/analytics_queries.py` · anything under `mobile/src` · anything under `archive/retired-tooling/mobile/maestro` ·
