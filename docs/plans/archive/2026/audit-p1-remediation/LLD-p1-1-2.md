...
| # | Plan says | Actually |
|---|---|---|
| a | "Law 20 records a native confirm 'poisoned every later step' (`README.md:159-166`)" (`:382`) | Law 20 is at `archive/retired-tooling/mobile/maestro/README.md:154-160` and is about **`hideKeyboard`**, not the share sheet. The nearer precedent is **law 17** (`:140-145`): "Deep links are dead (`openLink` → undismissable SpringBoard confirm on iOS 18)". Both support the W-1 waiver; cite law 17 as the primary. |
...
```python
    # Share loop (audit P1-1/P1-2 — docs/plans/archive/2026/audit-p1-remediation/plan-p1-1-2.md).
...
| **MA** | `archive/retired-tooling/mobile/maestro/flows/growth/share-links.yaml` | *(new)* | PRD § Maestro flow specs |
