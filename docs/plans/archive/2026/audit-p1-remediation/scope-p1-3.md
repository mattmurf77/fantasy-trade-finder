...
**Capture delta: none** — no screen's visuals change. `archive/retired-tooling/mobile/scripts/screen-freshness.sh` should flag nothing; if it does, something outside this scope moved.
