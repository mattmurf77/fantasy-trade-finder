...
README law 17 (`archive/retired-tooling/mobile/maestro/README.md:140-145`) records that an undismissable SpringBoard
...
**Pre-existing-flow audit:** `grep -rn "share" archive/retired-tooling/mobile/maestro/` returns **only prose**. No flow
...
### 5.2 `archive/retired-tooling/mobile/maestro/flows/growth/share-links.yaml`
...
# profile: standard
# flags: release
# source: docs/plans/archive/2026/audit-p1-remediation/PRD-p1-1-2.md §5.2
...
| `docs/feedback/items/` | **n/a** | Audit-driven; home is `docs/plans/archive/2026/audit-p1-remediation/` |
