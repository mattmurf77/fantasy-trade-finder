...
| 23 | `archive/retired-tooling/mobile/maestro/flows/p1-9-trade-found-inbox.yaml` | New — §Maestro delta. |
...
Header per `archive/retired-tooling/mobile/maestro/README.md` convention: `appId`, `# tc:`,
`# profile: likes-you-waiting`, `# flags: likes-you-waiting` (resolved fixture),
`# source: docs/plans/archive/2026/audit-p1-remediation/plan-p1-9.md`, `tags: [p1-9, notifications]`.
...
Settings notification block — verified by `grep -rl "notif\|push" archive/retired-tooling/mobile/maestro/`, whose
...
new `p1-9__trade-found-inbox-row` screenshot. Run `archive/retired-tooling/mobile/scripts/screen-freshness.sh` and
