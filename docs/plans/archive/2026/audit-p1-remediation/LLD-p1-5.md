...
| N3 | `archive/retired-tooling/mobile/maestro/flows/growth/invite-promotion.yaml` | PRD §Maestro, file A | whole file |
| N4 | `archive/retired-tooling/mobile/maestro/flows/growth/invite-promotion@espn.yaml` | PRD §Maestro, file B (**split — see correction 3**) | whole file |
...
- [ ] `archive/retired-tooling/mobile/maestro/flows/growth/` — P1-1/2 (Wave A) creates `share-links.yaml` in this directory.
...
`archive/retired-tooling/mobile/maestro/capture/matches@near-unlock.yaml` carries a 40-line investigation:
...
The seeded backend takes **one** `--profile` for the whole run (`archive/retired-tooling/mobile/scripts/sim-run.sh:21, 31,
