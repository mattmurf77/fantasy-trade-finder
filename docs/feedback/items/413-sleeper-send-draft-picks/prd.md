...
>
> **Date:** 2026-09-02 (#413) · **Scope:** [`docs/feedback/items/413-sleeper-send-draft-picks/scope.md`](scope.md) · **Mirrors:** the MFL propose route's split-and-encode (`_mfl_encode_ftf_picks`) and the ESPN route's hard block.
>
