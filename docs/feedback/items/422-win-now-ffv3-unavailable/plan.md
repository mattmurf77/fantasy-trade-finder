...
Shipped on operator go 2026-09-08: PR #292 squash-merged as `1371d2e5`, Render live 00:03:58Z, iOS 1.17.3 (155) (EAS `c0fe6e0d`) uploaded, submission `2742bdd6`, all seven items `fixed`. Decisions D-189–D-192; [recovery capture](../../recovery/2026-09-08-feedback-batch-422-428.md); consolidated operator checklist [testflight-checklist.md](testflight-checklist.md) **unrun**.
