...
| `test_unsupported_slots_message_names_distinct_slots_in_roster_order` | helper: `["QB","K","DL","DL","LB","IDP_FLEX"]` → "K, DL, LB, IDP_FLEX (4 of 6 …"; 13 offense-only slots → the "at most 12" sentence | helper does not exist |
