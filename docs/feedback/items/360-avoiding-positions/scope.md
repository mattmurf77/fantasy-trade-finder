...
Mobile: **do NOT** add `'trade.avoid_positions'` to `LAUNCHED_FLAG_DEFAULTS` (superseded by [D-163](../../../living-memory/DECISIONS.md) — that map fails open)
