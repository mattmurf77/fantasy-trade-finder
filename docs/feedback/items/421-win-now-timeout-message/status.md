...
```project-status
{
  "status": "in-progress",
  "updated": "2026-09-06",
  "summary": "#421 neutral Win Now timeout copy: merged and iOS uploaded; native validation pending; canonical #420",
  "evidence": "Canonical: ../420-win-now-loading/status.md. Release: ../419-rejected-interest-resurfacing/release.md. PR #283 merged as 988fa2d6; iOS 1.17.1 (149) build/submission FINISHED; #421 DB record read back fixed at 17:41:56 UTC. Apple tester availability remains unverified and physical TestFlight checks are UNRUN. Fixed is the feedback database state, not proof that installed clients received the new binary."
}
```
