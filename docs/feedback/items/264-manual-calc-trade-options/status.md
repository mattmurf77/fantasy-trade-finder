# Status — 264-manual-calc-trade-options

```project-status
{
  "status": "in-progress",
  "updated": "2026-08-08",
  "summary": "#264 — Manual calc trade options",
  "evidence": "Carried forward as the last documented disposition, not a fresh production audit. Prior index merge corrections take precedence over older pre-merge notes. Last documented index disposition: in-progress 2026-08-08 — teardown-remediation (worktree). Prior row preserved at ../../../reviews/2026/2026-09-06-project-status-migration/feedback-index.md."
}
```
