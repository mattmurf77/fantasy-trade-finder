...
**Older items (06-08/06-09, ids 26–44):** 26/33 (Trios tile cleanup) shipped as #83; 41 (league team count) as #82; 22/23/27/29 (tiers drag) as #84; 44 (multi-select bulk-move) as #85; 32/43 (multi-select rework, x-button) partially addressed by #84/#85 — **verify on next TestFlight build**. 35/36 (match accept failures) addressed by the FB-01 disposition fix. 28/30/31/34/37/38/39/40/42 are polish/design items — not yet scheduled. 21/25 are Claude probes (ignore).
