...
`docs/reviews/2026/2026-08-19-pick-badge-scale.md`. On the pricing path the correct inverse was already
...
best asset against a market median of **66.5** (`docs/reviews/2026/2026-08-19-ktc-pick-value-comparison.md`
...
pick at `years_out = 0` (`docs/reviews/2026/2026-08-19-ktc-pick-value-comparison.md` line 60 pins it at
...
`docs/reviews/2026/2026-08-19-pick-year-valuation.md` line 209 (*"Do firsts hold value YoY? **No.** Every
...
`docs/reviews/2026/2026-08-19-pick-year-valuation.md`, `-ktc-pick-value-comparison.md`,
`-pick-badge-scale.md`.
