...
> | Evidence | Where |
> |---|---|
> | Automated | Structural guards in [`mobile/tests/`](../../../../mobile/tests/README.md) (`npm run test:<name>`) + unit tests |
...
> 1. **[`mobile/scripts/testid-lint.sh`](../../../../mobile/scripts/testid-lint.sh) stays in CI.** Every `testID` these flows
...
>
> The former simulator pre-push gate has already been removed. Current CI and
> recorded evidence are the shipping checks; no simulator override is needed.
> See [the archive index](../README.md) for the relocation and active lint contract.
...
`docs/plans/archive/2026/mobile-testing/lld.md` Appendix A, cross-checked against source by
