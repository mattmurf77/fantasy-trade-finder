...
- When a comment in the code says "never do X", treat it as a constraint with a reason, not as advice — find the reason before overriding it. Generalized as [D-163](DECISIONS.md).
