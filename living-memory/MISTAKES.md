...
### M-005 — Building a feature a concurrent session had already shipped, and overriding a standing instruction I had read
...
- When a comment in the code says "never do X", treat it as a constraint with a reason, not as advice — find the reason before overriding it. Generalized as [D-098](DECISIONS.md).
