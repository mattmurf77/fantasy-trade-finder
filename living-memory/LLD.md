...
`backend/bakeoff_runner.py` ([plan](../docs/plans/three-model-bakeoff/PLAN.md), [scope](../docs/plans/three-model-bakeoff/scope-phase3.md)) sets four conventions for anything that runs models side by side:
