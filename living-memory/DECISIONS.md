...
**Decision:** Move the exit into the already-fixed stack header (`headerLeft` + title swap) at zero vertical cost, and register an Android `BackHandler` while a team is focused.
