...
| ID | Symptom | Area |
|---|---|---|
| G-062 | Web analytics emitted zero events for months: a fire-and-forget flag fetch vs a synchronous `boot()` | Web analytics / flag races |
...
### G-062 — a flag map that "resolves before most UI code runs" doesn't, and the events it gates vanish
