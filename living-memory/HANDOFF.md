...
**In flight:** two fresh Astra Ultra QA reviewers completing full independent round 2. Both focused suites pass 892 cases and original defect repro is GREEN. [Research](../docs/research/2026-09-06-trade-package-shapes.md) and all-45 read-only audit complete. Version 1.17.1 and privacy-checked archive prepared; physical checklist UNRUN.

**Blocked on:** final independent QA verdicts, exact-head CI and delivery verification. Current-batch owner preauthorization covers reviewed merge/live/TestFlight; no waiver. Live remains `4026ebc8`, personal-market policy ON, all three arms; new presentation knob absent. Existing build 148 uploaded, Apple availability unverified.
