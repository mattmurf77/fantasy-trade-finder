...
**Blocked on (operator):** nothing for the overhaul — the flag is live; install build 153 and run the [device checklist](../docs/plans/team-overhaul/QA.md), especially an MFL/ESPN league's send summary and the Sleeper tied-offer step.
