...
- **Highest-risk unverified item: the Android hardware `BackHandler` was never exercised.** No Android device or emulator was involved at any point, and it is the headline #302 fix. Operator will test in TestFlight (iOS), which does not cover it.
