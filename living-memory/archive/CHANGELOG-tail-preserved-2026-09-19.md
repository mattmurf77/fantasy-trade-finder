# Historical CHANGELOG tail preserved 2026-09-19

Entries removed from the active log during organization publication preparation, from the merged `801e00ea` / `b33b4da9` tree. These are dated claims, not current release instructions. Relative Markdown links are adjusted for this archive location. Earlier history remains in [the September 6 archive](CHANGELOG-through-2026-09-06.md).
